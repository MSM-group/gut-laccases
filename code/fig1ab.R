...
dat_A <-  metadat %>%
  dplyr::left_join(readr::read_csv("data/fig1a.csv"), by = c("ID" = "sample_id")) %>%
...
dat_B <- readr::read_csv("data/fig1b.csv")
...
ggplot2::ggsave("plots/fig1ab.jpg", dpi = 600, device = "jpeg", units = "in", width = 4.7, height = 4)